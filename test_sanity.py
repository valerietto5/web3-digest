...
class TestSanity(unittest.TestCase):
    ...
    def test_swap_ui_includes_wallet_aware_swap_input_controls(self):
        ...
        self.assertNotIn('class="swap-direction-control"', html)
        ...
        self.assertIn("flex: 0 1 92px;", html)
    ...
    def test_swap_ui_renders_preflight_diagnostics_in_debug_json(self):
        ...
        self.assertIn("<details class=\"card\" id=\"swapVisiblePreflightDebugWrap\"", html)
        ...
        self.assertIn('<details id="swapDebugWrap" class="card"', html)
        self.assertIn("Raw quote debug JSON", html)
        self.assertNotIn('<details class="card" id="swapVisiblePreflightDebugWrap" open', html)
        self.assertNotIn('<details id="swapDebugWrap" class="card" open', html)
